...
public class CatalogServiceTest
{
    ...
    public async Task GetBrandsAsync_Success()
    {
        ...
        _catalogItemRepository.Setup(s => s.GetBrandsAsync()).ReturnsAsync(pagingPaginatedBrandsSuccess);
    ...
    {
        // arrange
        _catalogItemRepository.Setup(s => s.GetBrandsAsync()).Returns((Func<UniversalGetItemsResponse<CatalogBrandDto>>)null!);
    ...
    {
        // arrange
        _catalogItemRepository.Setup(s => s.GetTypesAsync()).Returns((Func<UniversalGetItemsResponse<CatalogTypeDto>>)null!);
